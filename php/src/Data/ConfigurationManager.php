    ...
    public function SetDomain(string $domain) : void {
        ...
        if (!$this->shouldDomainValidationBeSkipped()) {
            ...
            if ($connection) {
                ...
                throw new InvalidSettingConfigurationException("The domain is not reachable on Port 443 from within this container. Have you opened port 443/tcp in your router/firewall? If yes is it most likely that the router or firewall forbids local access to your domain. You can work around that by setting up a local DNS-server.");
            }
